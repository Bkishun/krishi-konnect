...
import { createFarmerLandPost } from "@/lib/actions/farmerlandpost.action";
...
const FarmerPostForm = () => {
  ...
  const handleImageUpload = async (setFieldValue) => {
    ...
    try {
      ...
      imageData.append("upload_preset", "KrishiKonnect-farmerpost");
  ...
  return (
    <Formik
      ...
      onSubmit={async (values) => {
        console.log(values)
        const result = await createFarmerLandPost(values);
        console.log(result);
      }}
    >
