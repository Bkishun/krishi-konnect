...
export async function registerUser(user) {
  try {
    ...
    const newUser = new User({
      name : "namedfbddddndff",
      email: "authdddddUser.emffail",
      password: "3456dd543dddfff45cvb",
      adhaarNumber: "ddddddd",
      address: "kjhjkfflkjhff",
      userType: "ddddd",
      authUsername: "auddtdhUffser.nickname",
      authId: "autdddhdUffser.sid",
    });
